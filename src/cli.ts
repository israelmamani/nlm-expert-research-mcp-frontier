...
if(process.argv.slice(3).some(arg=>arg==='--force'||arg==='-f'))process.env.NLM_FORCE_REAUTH='1';
const {adapter,store}=createApp();
...
else if(command==='help') console.log('nlm-mcp doctor | nlm-mcp setup-auth [--force]');
